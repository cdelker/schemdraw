...
.. jupyter-execute::
    ...
    with schemdraw.Drawing() as d:
        ...
        d += elm.Resistor().right().length(d.unit*.75).label('R3', 'bottom').dot()
        d += elm.Line().up().length(d.unit/8).dot(open=True).label('Set', 'right').hold()
        ...
        d += elm.Resistor().left().length(d.unit*.75).label('R4', 'bottom').dot()
        d += elm.Line().up().length(d.unit/8).dot(open=True).label('Reset', 'right').hold()
...
.. jupyter-execute::
    ...
    with schemdraw.Drawing() as d:
        ...
        d += elm.Line().right().length(d.unit*.75).dot()
        ...
        d += elm.Line().up().at(Q2.collector).length(d.unit/3).dot()
        ...
        d += elm.Line().up().at(Q12.emitter).length(d.unit/4).dot()
        d += elm.Line().tox(Q9.emitter).dot()
        d += elm.Line().right().at(Q12.base).length(d.unit/4).dot()
        d += elm.Wire('|-').to(Q12.collector).dot().hold()
        d += elm.Line().right().length(d.unit*1.5)
        d += (Q13 := elm.BjtPnp().anchor('base').label('Q13'))
        d += elm.Line().up().length(d.unit/4).dot()
        d += elm.Line().tox(Q12.emitter)
        d += (K := elm.Line().down().at(Q13.collector).length(d.unit/5).dot())
        d += elm.Line().down()
        d += (Q16 := elm.BjtNpn().right().anchor('collector').label('Q16', ofst=-.1))
        d += elm.Line().left().at(Q16.base).length(d.unit/3).dot()
        ...
        d += elm.Line().left().at(Q15.base).length(d.unit/2).dot()
        ...
        d += elm.Line().down().at(Q19.emitter).length(d.unit/4).dot()
        d += elm.Line().left()
        ...
        d += elm.Line().right().length(d.unit*1.5).dot()
        ...
        d.push()
        d += elm.Line().down().length(d.unit/2).idot()
        ...
        d += elm.Line().down().length(d.unit/4).dot()
